...
<head>
    ...
    <style>
        ...
        .sidebar h2 { text-align: center; padding: 1.2rem 0; font-size: 1.4rem; font-weight: 600; border-bottom: 1px solid rgba(255,255,255,0.2);}
...
<aside class="sidebar">
    ...
    <a href="{{ route('expedientes.index') }}"><i class="bi bi-folder-plus"></i> Expedientes</a>
    <a href="{{ route('historia.index') }}"><i class="bi bi-file-earmark-medical"></i> Historia Clínica</a>
    <a href="{{ route('pacientes.index') }}" class="active"><i class="bi bi-person-lines-fill"></i> Pacientes</a>
    <a href="{{ route('notas.index') }}"><i class="bi bi-journal-medical"></i> Nota Médica</a>
    <a href="{{ route('usuario.perfil') }}"><i class="bi bi-person-circle"></i> Perfil</a>
